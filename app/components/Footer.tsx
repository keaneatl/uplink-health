  ...
  return (
    <footer className="bg-[#191919] mb-4 mx-auto text-white bottom-0 rounded-xl text-2xl flex flex-col justify-center items-center py-14 w-[98%] h-[700px] lg:flex-row lg:justify-evenly lg:h-96">
      <svg
        ...
        className="w-24 h-28 mb-auto lg:mb-0 lg:w-48 lg:h-52"
      >
        <path
      ...
      <div className="w-3/4 flex flex-col justify-center items-center p-0 gap-8 lg:flex-row lg:justify-around lg:items-start">
        <div className="flex flex-col justify-center items-center p-0 gap-4">
          <h1 className={`font-bold  ${playfair_display.className}`}>
            Payment Methods
          </h1>
          <div className="flex flex-row items-center p-0 gap-2">
            ...
            <Image
              ...
              height={60}
            />
            <Image src={discover} alt="Discover Logo" width={60} height={60} />
          </div>
        </div>
        <div className="flex flex-col justify-center text-center p-0 gap-4 lg:text-left">
          <h1 className={`font-bold  ${playfair_display.className}`}>
            Our Site
          </h1>
          <ul className={`${lato.className} font-normal  opacity-80`}>
            <li>
              <h2>Home</h2>
            </li>
            <li>
        ...
        <div className="flex flex-col justify-center p-0 gap-4 text-center lg:text-left">
          <h1 className={`font-bold  ${playfair_display.className}`}>About</h1>
          <ul
            className={`${lato.className} font-normal  opacity-80 text-center lg:text-left`}
          >
            <li>
